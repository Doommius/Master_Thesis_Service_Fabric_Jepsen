...
\end{tikzpicture}
        ...
        \begin{lstlisting}
        select * from accounts where value > 0;         -- Tj: Rj(P: Vset(P): x0)
        update accounts set value = INT_MAX where id = 1;     -- Ti: Wi(x1)
        select * from accounts where value > 0;         -- Tj: Rj(P: Vset(P): {})
        \end{lstlisting}
