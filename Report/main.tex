...
\subsubsection{Programming for Service Fabric}
...
A diagram of the service looks as the following. (TODO this diagram should be rotated 90 degrees to take up less space.)

\includegraphics[scale=0.5]{Report/images/Design_Stateful_service_1.drawio.png}
