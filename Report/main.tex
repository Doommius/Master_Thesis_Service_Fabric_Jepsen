...
%TODO write section on Implementation details SF 2
    ...
    %TODO runner handles configs, rates, hosts, ssh keys, test suite
    
    %TODO nemasis, killer, partion
...
\subsection{Final iteration of the design.}
    In this iteration the way transactions and calls between the client and server was changed, this required significant rewrite of the entire code and project.
    
    The first first major change was changing the API to do multi operational transactions. this required rebuilding the back-end to support this functionality which was greatly eased by using Postman and dotnetfiddle and curiousconcept json tools.
    
    The new code for the backend was simplified downto 2 main functions,
    \begin{lstlisting}[language=csh]
[HttpPut]
