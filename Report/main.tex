...
Formally it is defined \cite{ansisql1999} by disallowing P1
...
\subsection{BASE transaction models}
The catatfory of lineariza transaction models
...
\begin{itemize}
    PRAM is satisfied if the session order (the order of operations on each process) is a subset of the visibility order (what operations are visible to a given operatio
\end{itemize}   
