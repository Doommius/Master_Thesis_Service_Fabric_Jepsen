...
% Text Node
\draw (209,3) node [anchor=north west][inner sep=0.75pt]   [align=left] {A/C?};
% Text Node
\draw (207,94) node [anchor=north west][inner sep=0.75pt]   [align=left] {A/C?};
% Text Node
\draw (317.56,94) node [anchor=north west][inner sep=0.75pt]   [align=left] {Order};
% Text Node
\draw (143,100) node [anchor=north west][inner sep=0.75pt]   [align=left] {Now};
% Text Node
...
\end{tikzpicture}
\caption{P0: Dirty Write between $T_1$ and $T_2$}
\end{figure}